...
const getDate = document.querySelectorAll('.filter-date')
const getCategory = document.querySelectorAll('.filter-category')
const getAmount = document.querySelectorAll('.filter-amount')
